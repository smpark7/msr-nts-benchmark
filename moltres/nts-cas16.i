[GlobalParams]
  ...
  use_exp_form = false
  group_fluxes = 'group1 group2 group3 group4 group5 group6 group7 group8 group9 group10 group11 group12 group13 group14 group15 group16'
...
[Materials]
  [./fuel]
    ...
    base_file = '../xsdata/msr_XS_cas16.json'
    block = fuel
    material_key = 'fuel'
    interp_type = 'spline'
    prop_names = ''
